...
class ntripclient:
	def __init__(self):
		...
		self.nmea_gga           = '$GPGGA,020932.174,3717.324,N,12706.433,E,1,12,1.0,0.0,M,0.0,M,,*67'
#용인 '$GPGGA,020932.174,3717.324,N,12706.433,E,1,12,1.0,0.0,M,0.0,M,,*67'
#영대 '$GPGGA,113937.335,3549.931,N,12845.211,E,1,12,1.0,0.0,M,0.0,M,,*6D'
