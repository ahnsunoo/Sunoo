...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    if ((mode == 3) || (mode == 0))
    {
      ...
      if (imu_mode == 1) // go
      {
        printf("imu mode 111111111111111111111111111111111111111111");
        double startTime = (unsigned)time(NULL);
        double currentTime = (unsigned)time(NULL);
        double totalTime = currentTime - startTime;

        while (totalTime < EndTime1)
        {
          // printf("<----- while1------>\n");
          teleop_cmd_vel_data.angular.z = W_steering_angle;
          ...
          // printf("while 1. totalTime : %f\n", totalTime);
          // printf("W_motor_speed %d\n",W_motor_speed);
          // printf("W_steering_angle %d\n",W_steering_angle);
        }
        imu_mode = 2;
      }
      ...
      if (imu_mode == 2) // stop
      {
        printf("imu mode 2222222222222222222222222222222222");
        double startTime = (unsigned)time(NULL);
        double currentTime = (unsigned)time(NULL);
        double totalTime = currentTime - startTime;

        while (totalTime < EndTime2)
        {
          // printf("<----- while2------>\n");
          teleop_cmd_vel_data.angular.z = W_steering_angle;
          ...
          currentTime = (unsigned)time(NULL);
          totalTime = currentTime - startTime;
          // printf("while 2. totalTime : %f\n", totalTime);
          // printf("W_motor_speed stop----------------------------------------------------------\n");
      ...
      if (imu_mode == 3) // go
      {
        printf("imu mode 333333333333333333333333333333333333");
        double startTime = (unsigned)time(NULL);
        double currentTime = (unsigned)time(NULL);
        double totalTime = currentTime - startTime;

        while (totalTime < EndTime3)
        {
          // printf("<----- while3------>\n");
          teleop_cmd_vel_data.angular.z = W_steering_angle;
          teleop_cmd_vel_data.linear.x  = 110;
